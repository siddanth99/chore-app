      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div className="col-span-2">
            <a href="/" className="flex items-center gap-2 font-bold text-xl mb-4" aria-label="Chore App Home">
            ...
            <p className="text-sm text-muted-foreground mb-6 max-w-xs">
              Connecting people who need help with trusted local helpers. Get everyday chores done fast.
            </p>
            {/* Social Links */}
        ...
        <div className="mt-12 pt-8 border-t border-border flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} ChoreBid - Macherla Siddanth. All rights reserved.
          </p>
